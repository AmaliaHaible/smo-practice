...
void drawThrowMarkers(sead::PrimitiveRenderer* renderer, sead::Vector3f const* positions, sead::Vector3f const* directions, int count, int writeIndex, int capacity, sead::Color4f color = sead::Color4f(0.3f, 0.9f, 1.0f, 0.9f));
